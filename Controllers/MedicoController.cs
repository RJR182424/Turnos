    ...
    public class MedicoController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var medico = await _context.Medico
                ...
                .ThenInclude(e => e.Especialidad).FirstOrDefaultAsync();/*este es un INNER JOIN*/
            if (medico == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMedico,Nombre,Apellidos,Direccion,Telefono,Email,HorarioAtencionDesde,HorarioAtencionHasta")] Medico medico,
        int IdEspecialidad)
        {
